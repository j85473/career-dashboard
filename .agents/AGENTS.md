...
- **QUALIFICATION GUARDRAILS**: Standard scoring uses `data/resumes/core_resume.txt`, must decompose mandatory requirements, and deterministically caps unsupported mandatory requirements/domain/tenure at 59. Automatic inbox admission requires Aim >= 80 and guarded Experience >= 70.
