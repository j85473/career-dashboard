...
---
# Immutable Negative-Only Context Evaluator V6.2
...
- The chunk must have `schemaVersion: "native-scoring-batch-v6.2"`, `type: "context"`, 1–5 jobs, one non-empty batch ID, unique job IDs, and a versioned `contextProfile`.
