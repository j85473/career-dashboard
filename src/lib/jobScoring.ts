...
const TARGET_TITLE_SIGNALS: WeightedSignal[] = [
  ...
  { label: 'partner growth/activation/success', pattern: /\bpartner (?:growth(?: sales)?|activation|success) (?:manager|director|lead)\b|\b(?:manager|director|head|lead)(?:\s+of)?\s+partner (?:growth(?: sales)?|activation|success)\b/i, weight: 14 },
  ...
  { label: 'partner development', pattern: /\b(?:partner|channel) development (?:manager|director|lead)\b|\b(?:manager|director|head|lead)(?:\s+of)?\s+(?:partner|channel) development\b/i, weight: 13 },
  ...
  { label: 'distributed-network performance', pattern: /\b(?:territory|dealer|market|regional|retail|franchise|network) (?:performance|development) (?:manager|director|lead)\b|\b(?:manager|director|head|lead)(?:\s+of)?\s+(?:territory|dealer|market|regional|retail|franchise|network) (?:performance|development)\b/i, weight: 12 },
